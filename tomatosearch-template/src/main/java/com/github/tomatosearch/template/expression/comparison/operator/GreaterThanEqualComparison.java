 ...
 * @since 1.0.0
 */
public class GreaterThanEqualComparison extends AbstractCompareComparison {

	public GreaterThanEqualComparison(String text) {
		super(text);
	}
	...
	protected Boolean doEvaluate(Comparable<Object> left, Comparable<Object> right) {
		...
		if (this.comparisonText.equals(">=") || this.comparisonText.equals("=>")) {
